...
Scenario: Total sum of all songs played
	...
	When I add another song with name: "She Doesn't Mind", artist: "Sean Paul", duration: "3:17"
	And I have not played any songs yet so total sum of all songs should be 0
