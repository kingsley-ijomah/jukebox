...
Scenario: Search by index or name
	...
	Then it should give me name: 'Sexy And I Know It', artist: 'LMFAO', duration: '3:20'
	When I search for song by name: 'Rewing'
	Then it should give me name: 'Rewing', artist: 'Paolo Nutini', duration: '4:19'